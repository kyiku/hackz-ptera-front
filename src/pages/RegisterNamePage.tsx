/**
 * RegisterNamePage - 名前入力ページ（プレースホルダー）
 * Issue #37: 登録ダッシュボード（ハブ＆スポーク形式）
 *
 * TODO: 後続のissueで実装予定（スロットマシンUI）
 */
...
const RegisterNamePage = () => {
    ...
    return (
        <div data-testid="register-name-page" className="min-h-screen bg-white text-gray-800 flex items-center justify-center">
            <div className="text-center">
                <h1 className="text-4xl font-bold mb-4">名前入力</h1>
