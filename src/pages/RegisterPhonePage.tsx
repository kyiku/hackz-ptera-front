/**
 * RegisterPhonePage - 電話番号入力ページ（プレースホルダー）
 * Issue #37: 登録ダッシュボード（ハブ＆スポーク形式）
 *
 * TODO: 後続のissueで実装予定（黒電話ダイヤルUI）
 */
...
const RegisterPhonePage = () => {
    ...
    return (
        <div data-testid="register-phone-page" className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
            <div className="text-center">
                <h1 className="text-4xl font-bold mb-4">電話番号入力</h1>
